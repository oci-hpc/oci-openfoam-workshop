...
Step 2: Creating an SSH keypair
...
Step 4: Adding Public Key to Oracle Cloud Infrastructure (OCI)
...
Step 5: Configuring the CLI with your OCI credentials
...
1. Before deploying, you need to change the values in the config.json file. The variables depend on the stack that you are deploying. An example config.json looks like this
    {
        "tenancy_ocid": "",
        "region": "us-phoenix-1",
        "compartment_ocid": "",
...
Step 8: Connecting to the Stack
